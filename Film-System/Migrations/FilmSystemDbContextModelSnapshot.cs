...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmSystem.Models.Genre", b =>
                {
                    ...
                    b.Property<int?>("MovieGenreId_movieGenre")
                        .HasColumnType("int");

                    b.Property<int?>("PersonGenreId_personGenre")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovieGenreId_movieGenre");

                    b.HasIndex("PersonGenreId_personGenre");
            ...
            modelBuilder.Entity("FilmSystem.Models.Movie", b =>
                {
                    ...
                    b.Property<int?>("MovieRatingId_movieRating")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovieRatingId_movieRating");
            ...
            modelBuilder.Entity("FilmSystem.Models.Genre", b =>
                {
                    b.HasOne("FilmSystem.Models.MovieGenre", null)
                        .WithMany("Genres")
                        .HasForeignKey("MovieGenreId_movieGenre");

                    b.HasOne("FilmSystem.Models.PersonGenre", null)
                        .WithMany("Genres")
                        .HasForeignKey("PersonGenreId_personGenre");
                });
            ...
            modelBuilder.Entity("FilmSystem.Models.Movie", b =>
                {
                    ...
                    b.HasOne("FilmSystem.Models.MovieRating", null)
                        .WithMany("Movies")
                        .HasForeignKey("MovieRatingId_movieRating");
            ...
            modelBuilder.Entity("FilmSystem.Models.Person", b =>
                {
                    b.HasOne("FilmSystem.Models.Movie", null)
                        .WithMany("Persons")
